            ...
            <div className="overflow-x-auto">
                <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-gray-900/50">
                        <tr>
                            <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase w-2/12">Sản phẩm</th>
                            <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase w-2/12">Danh mục</th>
                            <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase w-2/12">Nhà cung cấp</th>
                            <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase w-1/12">Giá</th>
                            <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase w-1/12">Số lượng</th>
                            <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase w-2/12">Ngày hết hạn</th>
                    ...
                    {/* <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                        {ProductList.map((item, i) => (
                            ...
                            >
                                ...
                                <td className="px-4 py-2">{item.category.category_name}</td>
                                <td className="px-4 py-2">{item.supplier.supplier_name}</td>
                                <td className="px-4 py-2">{item.price.toLocaleString('vi-VN')}</td>
